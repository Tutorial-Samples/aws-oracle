...
FROM maven:3.6.3-jdk-11 as aws-oracle
WORKDIR /aws-oracle
...
ARG DEPENDENCY=/aws-oracle/target/dependency
COPY --from=aws-oracle ${DEPENDENCY}/BOOT-INF/lib /app/lib
COPY --from=aws-oracle ${DEPENDENCY}/META-INF /app/META-INF
COPY --from=aws-oracle ${DEPENDENCY}/BOOT-INF/classes /app
